...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "HealWise — Women's Pain Relief & Weight Management Clinic" },
      { name: "description", content: "Personalized pain relief, recovery, and weight management programs for women. Non-invasive, science-backed therapies in a clinical sanctuary." },
      { property: "og:title", content: "HealWise — Women's Pain Relief & Weight Management Clinic" },
      { property: "og:description", content: "Personalized pain relief, recovery, and weight management programs for women. Non-invasive, science-backed therapies in a clinical sanctuary." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,400;0,9..144,600;0,9..144,700;1,9..144,400&family=Manrope:wght@400;500;600;700&display=swap" },
